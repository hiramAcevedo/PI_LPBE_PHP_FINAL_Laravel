        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-deeper-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-200">
                    <form id="upload-form" method="POST" action="{{ route('images.store-direct') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <!-- Área de carga con drag & drop y vista previa -->
                        <div class="mt-4">
                            ...
                            <div id="drop-area" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-md border-gray-300 dark:border-gray-600 transition duration-300 ease-in-out hover:border-purple-400 dark:hover:border-purple-500 cursor-pointer">
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        La imagen se añadirá a tu galería general.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            <a href="{{ route('dashboard') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Cancelar</a>
